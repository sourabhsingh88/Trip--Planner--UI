...
@Component({
    ...
    templateUrl: './trip-continue.component.html',
    styleUrls: ['./trip-continue.component.scss']
})
export class TripContinueComponent {
    ...
    constructor(private tripService: TripService, private dialog: MatDialog,private router: Router) {
        console.log("TripContinueComponent: Object Created");
    ...
    loadFilteredTrips() {
        this.tripService.getAllContinousTrips(this.tripPlannerId,this.page, this.size).subscribe({
            next: (res: any) => {
                this.trips = res.data;
